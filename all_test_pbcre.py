...
if __name__ == "__main__":
    ...
    namedatasets = ['aer', 'australian', 'crx', 'data-eiz-categorica', 'default+of+credit+card+clients', 'german', 'gmsc', 'heloc', 'hmeq', 'loan_data_set', 'ppdaiData']
    #namedatasets = ['aer', 'australian', 'crx']
    for namedataset in namedatasets:
        start_time = time.time()# inicio de ejecución
    ...
    df_times.to_excel('./patterns/execution_times_all.xlsx',index=False)
    df_times.to_csv('./patterns/execution_times_all.csv',index=False)